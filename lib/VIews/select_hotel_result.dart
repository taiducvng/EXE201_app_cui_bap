...
import 'confirm_booking_room.dart';

class HotelResultScreen extends StatefulWidget {
  static const String routeName = '/result_room_screen';
                                  ...
                                  ElevatedButton(
                                    onPressed: () {
                                      Navigator.of(context).pushNamed(
                                        ConfirmRoomBookingResultScreen
                                            .routeName,
                                        arguments: {
                      ...
                      child: Card(
                        ...
                        child: Stack(
                          children: [
                            Ink.image(
                              image: NetworkImage(
                                  "https://images.unsplash.com/photo-1572987669554-0ba2ba9aee1f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"),
                              height: (350 / 1080) * height,
                              width: width,
                              fit: BoxFit.fill,
                            ),
