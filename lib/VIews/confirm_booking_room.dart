...
import 'package:metravel_demo1/VIews/success_booking_demo.dart';
...
class ConfirmRoomBookingResultScreen extends StatefulWidget {
  static const String routeName = '/confirm_booking_screen';
  ...
  final int? bookPrice;
  @override
  State<ConfirmRoomBookingResultScreen> createState() =>
      _ConfirmRoomBookingResultScreenState();
}

class _ConfirmRoomBookingResultScreenState
    extends State<ConfirmRoomBookingResultScreen> {
  @override
                        ...
                        child: ElevatedButton(
                            onPressed: () {
                              Navigator.of(context).pushNamed(
                                SuccessRoomBookingResultScreen.routeName,
                                arguments: {
