...
class SuccessRoomBookingResultScreen1 extends StatefulWidget {
  static const String routeName = '/success_booking_screen_1';
  ...
  @override
  State<SuccessRoomBookingResultScreen1> createState() =>
      _SuccessRoomBookingResultScreen1State();
}

class _SuccessRoomBookingResultScreen1State
    extends State<SuccessRoomBookingResultScreen1> {
  @override
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.all(16),
                          child: ReusableText(
                            text: "Please bring the app with you",
                            style: appstyle(
                                14, Color(kDark.value), FontWeight.w400),
                          ),
                        ),
                        ReusableText(
                          text: "when check in so we can approve your room",
                          style:
