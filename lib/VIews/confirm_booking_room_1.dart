...
import 'package:metravel_demo1/VIews/success_booking_demo_momo.dart';
...
class ConfirmRoomBookingResultScreen1 extends StatefulWidget {
  static const String routeName = '/confirm_booking_screen_1';
  ...
  final int? bookPrice;
  @override
  State<ConfirmRoomBookingResultScreen1> createState() =>
      _ConfirmRoomBookingResultScreen1State();
}

class _ConfirmRoomBookingResultScreen1State
    extends State<ConfirmRoomBookingResultScreen1> {
...
//
                  ...
                  DropdownButton<String>(
                    ...
                    items: [
                      ...
                      DropdownMenuItem<String>(
                          value: 'Momo', child: Text("E-wallets payment")),
                      DropdownMenuItem<String>(
                          value: 'VND', child: Text("Pay as you stay")),
                    ],
                      ...
                      Center(
                        child: ElevatedButton(
                            onPressed: () {
                              ...
                              } else if (dropdownValue == 'Momo') {
                                Navigator.of(context).pushNamed(
                                  SuccessRoomBookingResultScreenMomo.routeName,
                                  arguments: {
                                    'selectDate': selectDate,
                                    'guestAndRoom': guestAndRoom,
                                    'dropdownValueForLocation':
