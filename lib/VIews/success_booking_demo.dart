...
import 'package:metravel_demo1/components/reusable_text_for_logo.dart'
    show ReusableTextForLogo;

class SuccessRoomBookingResultScreen extends StatefulWidget {
  static const String routeName = '/success_booking_screen';
  ...
  @override
  State<SuccessRoomBookingResultScreen> createState() =>
      _SuccessRoomBookingResultScreenState();
}

class _SuccessRoomBookingResultScreenState
    extends State<SuccessRoomBookingResultScreen> {
  @override
